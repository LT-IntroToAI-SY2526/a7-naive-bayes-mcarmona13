...
class BayesClassifier:
    ...
    def classify(self, text: str) -> str:
        ...
        vocab_size = len(self.pos_freqs) + len(self.neg_freqs)
        ...
        for token in tokens:
            ...
            pos_prob = (pos_count + 1) / (pos_total +vocab_size)
            neg_prob = (neg_count + 1) / (neg_total + vocab_size)

            pos_probability += math.log(pos_prob)
            neg_probability += math.log(neg_prob)
